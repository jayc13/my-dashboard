...
clear
echo -e "\033[1;35m\033[1m\033[48;5;230m==========   S T A R T I N G   L O C A L   D E P L O Y   ==========\033[0m"
echo -e "\033[1;36mDeployment directory: ${WWW_DIR}\033[0m"

echo -e "\033[1;34m🔹 Step 0: Checking if the script is run from the project root...\033[0m"
cd "$(git rev-parse --show-toplevel)" || exit

echo -e "\033[1;34m🔹 Step 1: Installing dependencies...\033[0m"
pnpm install --silent

echo -e "\033[1;33m🔸 Step 2: Running linter...\033[0m"
pnpm --filter=client run lint &>/dev/null  || { echo -e "\033[1;31mLint failed.\033[0m"; exit 1; }

echo -e "\033[1;32m🛠️Step 3: Building client...\033[0m"
cd scripts || exit
...
echo -e "\033[1;31m🗑️Step 4: Removing old dashboard version...\033[0m"
rm -rf ${WWW_DIR}/* &>/dev/null

echo -e "\033[1;36m🚀 Step 5: Copying the new version...\033[0m"
cp -r ./client/dist/* ${WWW_DIR}/ &>/dev/null

echo -e "\033[1;35m✅  Deployment completed successfully!\033[0m"
...
if command -v terminal-notifier &> /dev/null; then
    ...
    echo -e "\033[1;33m🔔 Install terminal-notifier for system notifications: brew install terminal-notifier\033[0m"
fi

echo -e "\033[1;35m\033[1m\033[48;5;230m==========   L O C A L   D E P L O Y   C O M P L E T E D   ==========\033[0m"
echo -e "\033[1;33mYou can now access the dashboard at ${DASHBOARD_URL}\033[0m"
