...
describe('TodoQuickAdd', () => {
  ...
  it('renders quick add form', () => {
    render(
      <TodoQuickAdd value="" isCreating={false} onChange={mockOnChange} onSubmit={mockOnSubmit} />,
    );
  ...
  it('displays input value', () => {
    ...
    const input = screen
      .getByTestId('todo-quick-add-input')
  ...
  it('disables button when both value is empty and isCreating is true', () => {
    render(
      <TodoQuickAdd value="" isCreating={true} onChange={mockOnChange} onSubmit={mockOnSubmit} />,
    );
