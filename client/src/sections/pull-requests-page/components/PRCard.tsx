...
import { Card, CardContent, Typography, Box, IconButton, Skeleton, Chip } from '@mui/material';
...
const PRCard = ({ pr, onDelete }: PRCardProps) => {
  ...
  return (
    <Card
      ...
      sx={
        isApproved
          ? { border: '2px solid #4caf50', boxShadow: '0 0 10px #4caf5040', padding: 0 }
          : { padding: 0 }
      }
              ...
              {getPRAge(details.createdAt) > 0 && (
                <Typography
                  ...
                  sx={{
                    ...
                    fontWeight: 'bold',
                    color:
                      getPRAgeColor(getPRAge(details.createdAt)) === 'error'
                        ? 'error.main'
                ...
                >
                  ({getPRAge(details.createdAt)}{' '}
                  {getPRAge(details.createdAt) === 1 ? 'day' : 'days'} old)
                </Typography>
              )}
            </Box>
          </Box>
