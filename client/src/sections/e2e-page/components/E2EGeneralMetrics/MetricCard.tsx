  ...
  return (
    <Card variant="outlined" sx={{ height: '100%', flexGrow: 1, borderRadius: 4 }}>
      <CardContent sx={{ padding: 4 }}>
        <Stack direction="column" sx={{ justifyContent: 'space-between', flexGrow: '1', gap: 0 }}>
          <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography component="h2" variant="h6" color="text.secondary">
              <strong>{stat.label}</strong>
            </Typography>
            {hasPreviousValue && (
              <TrendChip trend={trend} trendLabel={trendLabel} color={trendColor} />
            )}
          </Stack>
        ...
        {hasPreviousValue && (
          <>
            ...
            <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                <strong>
                  {stat.formattedValue ? stat.formattedValue(stat.prevValue!) : stat.prevValue}
                </strong>
              </Typography>
            </Stack>
          </>
