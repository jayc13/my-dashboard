          ...
          {loadingAppDetails ? (
            ...
            <Box>
              <Box sx={{ p: 2, bgcolor: 'background.default' }}>
                <Typography
                  variant="body2"
                  sx={{ display: 'flex', alignItems: 'center', gap: 1, lineHeight: '34px' }}
                >
                ...
                {result.lastRun && (
                  <Box display="flex" alignItems="center">
                    ...
                    <LastRunStatus status={result.lastRun.status} />
              ...
              <MenuList dense>
                ...
                {result.pipelineUrl && (
                  <MenuItem onClick={() => onOpenUrl(result.pipelineUrl!)}>
                    <OpenInNewIcon sx={{ mr: 1, fontSize: 20 }} />
                    Open in Pipelines
                  </MenuItem>
                )}
