  ...
  if (!isSupported) {
    return (
      <Container maxWidth="xl" sx={{ py: 2 }}>
        <Alert severity="warning" sx={{ mb: 2 }} onClose={() => setIsDismissed(true)}>
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 2 }}>
      ...
      <Dialog open={showDialog} onClose={handleCloseDialog} data-testid="permission-dialog">
        ...
        <DialogContent>
          <DialogContentText>
            Would you like to enable push notifications? This will allow you to receive real-time
            updates about new tickets, pull requests, and other important dashboard events even when
            the app is not open.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
