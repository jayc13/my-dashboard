...
describe('NotificationCenter', () => {
  ...
  it('renders notification icon with badge', () => {
    render(
      <NotificationCenter notifications={mockNotifications} refetchNotifications={mockRefetch} />,
    );
  ...
  it('shows empty state when no notifications', async () => {
    render(<NotificationCenter notifications={[]} refetchNotifications={mockRefetch} />);
  ...
  it('handles mark as read error', async () => {
    ...
    await waitFor(() => {
      expect(enqueueSnackbar).toHaveBeenCalledWith('Failed to mark notification as read', {
        variant: 'error',
      });
    });
  });
  ...
  it('handles delete error', async () => {
    ...
    await waitFor(() => {
      expect(enqueueSnackbar).toHaveBeenCalledWith('Failed to delete notification', {
        variant: 'error',
      });
    });
  });
  ...
  it('handles null notifications', () => {
    render(<NotificationCenter notifications={null} refetchNotifications={mockRefetch} />);
  ...
  it('handles undefined notifications', () => {
    render(<NotificationCenter notifications={undefined} refetchNotifications={mockRefetch} />);
